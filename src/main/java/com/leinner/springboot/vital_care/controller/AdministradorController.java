...
public class AdministradorController {
    ...
    public String registrarPaciente(@ModelAttribute Paciente paciente, Model model) {
        if (pacienteService.obtenerPacientePorId(paciente.getNumeroDocumento()) != null
                || medicoService.obtenerMedicoPorId(paciente.getNumeroDocumento()) != null
                || administradorService.obtenerAdministradorPorId(paciente.getNumeroDocumento()) != null) {
    ...
    public String registrarMedico(@ModelAttribute Medico medico, Model model) {
        if (pacienteService.obtenerPacientePorId(medico.getNumeroDocumento()) != null
                || medicoService.obtenerMedicoPorId(medico.getNumeroDocumento()) != null
                || administradorService.obtenerAdministradorPorId(medico.getNumeroDocumento()) != null) {
            model.addAttribute("error", "El número de documento ya está registrado");
            return "Administrador/Registrar/RegistroMedicos";
        } else {
    ...
    public String registrarAdministrador(@ModelAttribute Administrador admin, Model model) {
        if (pacienteService.obtenerPacientePorId(admin.getNumeroDocumento()) != null
                || medicoService.obtenerMedicoPorId(admin.getNumeroDocumento()) != null
                || administradorService.obtenerAdministradorPorId(admin.getNumeroDocumento()) != null) {
            model.addAttribute("error", "El número de documento ya está registrado");
            return "Administrador/Registrar/RegistroAdministrador";
        } else {
